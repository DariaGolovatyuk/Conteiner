...
public class ListNumberTest {
    ...
    public void setNumber()throws Exception{
        ...
        list1.addNumber(5.0,1);
        list1.addNumber(3.0, 1);
        list1.addNumber(4.0, 2);
    ...
    public void addNumber_NotCorrect() {
        boolean tmp=list1.addNumber(4.0, 6);
    ...
    public void addNumber() {
        ...
        String result2=" 3.0 4.0 5.0 2.0 ";
        Assert.assertEquals(result1,result2);
    }

    @org.junit.Test
    public void deleteNumber_NotCorrect() {
        boolean tmp=list1.deleteNumber(6);
        Assert.assertEquals(tmp,false);
    }
    ...
    public void getElem_NotCorrect() {
        Assert.assertEquals(list1.getElem(6),null);
    }
